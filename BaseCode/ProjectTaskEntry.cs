...
namespace PX.Objects.PM
{
	public class ProjectTaskEntry : PXGraph<ProjectTaskEntry, PMTask>
	{
		...
		protected virtual void _(Events.FieldUpdated<PMTask, PMTask.completedPctMethod> e)
		{
			...
			{
				decimal? completedPercent = PMTaskCompletedAttribute.CalculateTaskCompletionPercentage(this, e.Row);
				Task.Cache.SetValue<PMTask.completedPercent>(e.Row, completedPercent);
				Task.Cache.MarkUpdated(e.Row);
			}
		}
