...
namespace ProjectTask
{
  ...
  public class PMSampleTesting : IBqlTable
  {
    ...
    [PXStringList(
            new string[] 
            {
                SampleStatus.Contacted1, SampleStatus.Contacted2, SampleStatus.ClientCalled, SampleStatus.TPARKContacted, SampleStatus.WaitingonInfo, SampleStatus.InProcess, SampleStatus.Completed, SampleStatus.Ghost, SampleStatus.NA
            }, 
            new string[]
            {
                MessageSampleStatus.Contacted1, MessageSampleStatus.Contacted2, MessageSampleStatus.ClientCalled, MessageSampleStatus.TPARKContacted, MessageSampleStatus.WaitingonInfo, MessageSampleStatus.InProcess, MessageSampleStatus.Completed, MessageSampleStatus.Ghost, MessageSampleStatus.NA
            })]
